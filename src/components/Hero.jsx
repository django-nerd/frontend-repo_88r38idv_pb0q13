...
export default function Hero({ onIngest, onScheduled }) {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="mt-8 flex flex-wrap gap-3">
              ...
              <button onClick={onScheduled} className="px-5 py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-semibold shadow-lg shadow-emerald-600/20 transition-colors">
                Run Scheduled Crawl
              </button>
